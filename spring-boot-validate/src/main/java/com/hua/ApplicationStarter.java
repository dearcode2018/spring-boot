...
public class ApplicationStarter
{
	...
	public static void main(String[] args)
	{
		...
		//System.exit(SpringApplication.exit(SpringApplication.run(ApplicationStarter.class, args)));
	}
	 ...
	 */
/*	@Bean
	public ExitCodeGenerator existCodeGenerator()
	{
		System.out.println("ApplicationStarter.existCodeGenerator()");
